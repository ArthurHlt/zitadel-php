...
/**
 * Userv2LoginNameQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class Userv2LoginNameQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2LoginNameQuery';
    ...
    */
    ...
    public function setLoginName($loginName)
    {
        ...
        if ((mb_strlen($loginName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $loginName when calling Userv2LoginNameQuery., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($loginName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $loginName when calling Userv2LoginNameQuery., must be bigger than or equal to 1.');
        }
