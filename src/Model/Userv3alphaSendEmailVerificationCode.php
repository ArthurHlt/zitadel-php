...
/**
 * Userv3alphaSendEmailVerificationCode Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv3alphaSendEmailVerificationCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv3alphaSendEmailVerificationCode';
    ...
    */
     ...
     * Sets urlTemplate
     *
     * @param string|null $urlTemplate Optionally set a url_template, which will be used in the verification mail sent by ZITADEL to guide the user to your verification page. If no template is set, the default ZITADEL url will be used.
     *
     * @return self
     */
    public function setUrlTemplate($urlTemplate)
    {
        ...
        if ((mb_strlen($urlTemplate) > 200)) {
            throw new \InvalidArgumentException('invalid length for $urlTemplate when calling Userv3alphaSendEmailVerificationCode., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($urlTemplate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $urlTemplate when calling Userv3alphaSendEmailVerificationCode., must be bigger than or equal to 1.');
        }
