...
/**
 * Userv2RedirectURLs Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2RedirectURLs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2RedirectURLs';
    ...
    */
    ...
    public function setSuccessUrl($successUrl)
    {
        ...
        if ((mb_strlen($successUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $successUrl when calling Userv2RedirectURLs., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($successUrl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $successUrl when calling Userv2RedirectURLs., must be bigger than or equal to 1.');
        }
    ...
    public function setFailureUrl($failureUrl)
    {
        ...
        if ((mb_strlen($failureUrl) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $failureUrl when calling Userv2RedirectURLs., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($failureUrl) < 1)) {
            throw new \InvalidArgumentException('invalid length for $failureUrl when calling Userv2RedirectURLs., must be bigger than or equal to 1.');
        }
