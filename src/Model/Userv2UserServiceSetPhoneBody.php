...
/**
 * Userv2UserServiceSetPhoneBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2UserServiceSetPhoneBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2UserServiceSetPhoneBody';
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 200)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Userv2UserServiceSetPhoneBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Userv2UserServiceSetPhoneBody., must be bigger than or equal to 1.');
        }
