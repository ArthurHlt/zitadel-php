...
/**
 * Objectv2betaDetails Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Objectv2betaDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'objectv2betaDetails';
    ...
    */
     ...
     * Sets changeDate
     *
     * @param \DateTime|null $changeDate on read: the timestamp of the last event reduced by the projection  on manipulation: the timestamp of the event(s) added by the manipulation
     *
     * @return self
     */
