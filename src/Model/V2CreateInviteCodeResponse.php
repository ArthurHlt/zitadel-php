...
/**
 * V2CreateInviteCodeResponse Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V2CreateInviteCodeResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2CreateInviteCodeResponse';
    ...
    */
     ...
     * Sets inviteCode
     *
     * @param string|null $inviteCode The invite code is returned if the verification was set to return_code.
     *
     * @return self
     */
