...
/**
 * V2UserAgentQuery Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V2UserAgentQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2UserAgentQuery';
    ...
    */
    ...
    public function setFingerprintId($fingerprintId)
    {
        ...
        if ((mb_strlen($fingerprintId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $fingerprintId when calling V2UserAgentQuery., must be smaller than or equal to 200.');
        }
