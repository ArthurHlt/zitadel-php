...
/**
 * Userv2betaOrganizationIdQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class Userv2betaOrganizationIdQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2betaOrganizationIdQuery';
    ...
    */
    ...
    public function setOrganizationId($organizationId)
    {
        ...
        if ((mb_strlen($organizationId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $organizationId when calling Userv2betaOrganizationIdQuery., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($organizationId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $organizationId when calling Userv2betaOrganizationIdQuery., must be bigger than or equal to 1.');
        }
