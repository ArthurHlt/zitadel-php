...
/**
 * Idpv1AppleConfig Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Idpv1AppleConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'idpv1AppleConfig';
    ...
    */
     ...
     * Sets clientId
     *
     * @param string|null $clientId Client id (App ID or Service ID) provided by Apple
     *
     * @return self
     */
     ...
     * Sets teamId
     *
     * @param string|null $teamId Team ID provided by Apple
     *
     * @return self
     */
     ...
     * Sets keyId
     *
     * @param string|null $keyId ID of the private key generated by Apple
     *
     * @return self
     */
