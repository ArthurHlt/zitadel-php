...
/**
 * ManagementServiceUpdateHumanProfileBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class ManagementServiceUpdateHumanProfileBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementServiceUpdateHumanProfileBody';
    ...
    protected static $openAPITypes = [
        ...
        'gender' => '\ArthurHlt\Zitadel\Model\Userv1Gender'
    ];
    ...
    */
    ...
    public function setFirstName($firstName)
    {
        ...
        if ((mb_strlen($firstName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling ManagementServiceUpdateHumanProfileBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($firstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling ManagementServiceUpdateHumanProfileBody., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($lastName)
    {
        ...
        if ((mb_strlen($lastName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling ManagementServiceUpdateHumanProfileBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($lastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling ManagementServiceUpdateHumanProfileBody., must be bigger than or equal to 1.');
        }
    ...
    public function setNickName($nickName)
    {
        ...
        if ((mb_strlen($nickName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $nickName when calling ManagementServiceUpdateHumanProfileBody., must be smaller than or equal to 200.');
        }
    ...
    public function setDisplayName($displayName)
    {
        ...
        if ((mb_strlen($displayName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling ManagementServiceUpdateHumanProfileBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($displayName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling ManagementServiceUpdateHumanProfileBody., must be bigger than or equal to 1.');
        }
    ...
    public function setPreferredLanguage($preferredLanguage)
    {
        ...
        if ((mb_strlen($preferredLanguage) > 10)) {
            throw new \InvalidArgumentException('invalid length for $preferredLanguage when calling ManagementServiceUpdateHumanProfileBody., must be smaller than or equal to 10.');
        }
     ...
     * Gets gender
     *
     * @return \ArthurHlt\Zitadel\Model\Userv1Gender|null
     */
     ...
     * Sets gender
     *
     * @param \ArthurHlt\Zitadel\Model\Userv1Gender|null $gender gender
     *
     * @return self
     */
