...
/**
 * Userv2UserServiceRetrieveIdentityProviderIntentBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2UserServiceRetrieveIdentityProviderIntentBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2UserServiceRetrieveIdentityProviderIntentBody';
    ...
    */
    ...
    public function setIdpIntentToken($idpIntentToken)
    {
        ...
        if ((mb_strlen($idpIntentToken) > 200)) {
            throw new \InvalidArgumentException('invalid length for $idpIntentToken when calling Userv2UserServiceRetrieveIdentityProviderIntentBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($idpIntentToken) < 1)) {
            throw new \InvalidArgumentException('invalid length for $idpIntentToken when calling Userv2UserServiceRetrieveIdentityProviderIntentBody., must be bigger than or equal to 1.');
        }
