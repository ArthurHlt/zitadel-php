...
/**
 * Userv2EmailQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class Userv2EmailQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2EmailQuery';
    ...
    */
    ...
    public function setEmailAddress($emailAddress)
    {
        ...
        if ((mb_strlen($emailAddress) > 200)) {
            throw new \InvalidArgumentException('invalid length for $emailAddress when calling Userv2EmailQuery., must be smaller than or equal to 200.');
        }
