...
/**
 * Oidcv2AuthRequest Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Oidcv2AuthRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'oidcv2AuthRequest';
    ...
    protected static $openAPITypes = [
        ...
        'scope' => 'string[]',
        'redirectUri' => 'string',
        'prompt' => '\ArthurHlt\Zitadel\Model\Oidcv2Prompt[]',
        'uiLocales' => 'string[]',
        'loginHint' => 'string',
        'maxAge' => 'string',
        'hintUserId' => 'string'
    ...
    */
     ...
     * Gets prompt
     *
     * @return \ArthurHlt\Zitadel\Model\Oidcv2Prompt[]|null
     */
     ...
     * Sets prompt
     *
     * @param \ArthurHlt\Zitadel\Model\Oidcv2Prompt[]|null $prompt Prompts that must be displayed to the user
     *
     * @return self
     */
