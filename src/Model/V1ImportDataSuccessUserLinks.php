...
/**
 * V1ImportDataSuccessUserLinks Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1ImportDataSuccessUserLinks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1ImportDataSuccessUserLinks';
    ...
    */
     ...
     * Sets externalUserId
     *
     * @param string|null $externalUserId externalUserId
     *
     * @return self
     */
