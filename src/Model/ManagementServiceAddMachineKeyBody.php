...
/**
 * ManagementServiceAddMachineKeyBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class ManagementServiceAddMachineKeyBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManagementServiceAddMachineKeyBody';
    ...
    */
     ...
     * Sets expirationDate
     *
     * @param \DateTime|null $expirationDate The date the key will expire and no logins will be possible
     *
     * @return self
     */
     ...
     * Sets publicKey
     *
     * @param string|null $publicKey Optionally provide a public key of your own generated RSA private key.
     *
     * @return self
     */
    public function setPublicKey($publicKey)
    {
        ...
        if ((!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", ObjectSerializer::toString($publicKey)))) {
            throw new \InvalidArgumentException("invalid value for \$publicKey when calling ManagementServiceAddMachineKeyBody., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
