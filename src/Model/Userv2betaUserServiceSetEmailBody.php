...
/**
 * Userv2betaUserServiceSetEmailBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2betaUserServiceSetEmailBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2betaUserServiceSetEmailBody';
    ...
    protected static $openAPITypes = [
        'email' => 'string',
        'sendCode' => '\ArthurHlt\Zitadel\Model\Userv2betaSendEmailVerificationCode',
        'returnCode' => 'object',
        'isVerified' => 'bool'
    ];
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 200)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Userv2betaUserServiceSetEmailBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($email) < 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling Userv2betaUserServiceSetEmailBody., must be bigger than or equal to 1.');
        }
     ...
     * Gets sendCode
     *
     * @return \ArthurHlt\Zitadel\Model\Userv2betaSendEmailVerificationCode|null
     */
     ...
     * Sets sendCode
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2betaSendEmailVerificationCode|null $sendCode sendCode
     *
     * @return self
     */
