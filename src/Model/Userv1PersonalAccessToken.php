...
/**
 * Userv1PersonalAccessToken Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv1PersonalAccessToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv1PersonalAccessToken';
    ...
    */
     ...
     * Sets expirationDate
     *
     * @param \DateTime|null $expirationDate the date the token will expire
     *
     * @return self
     */
     ...
     * Sets scopes
     *
     * @param string[]|null $scopes scopes granted to the token
     *
     * @return self
     */
