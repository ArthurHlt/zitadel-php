...
/**
 * Userv2SendEmailVerificationCode Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2SendEmailVerificationCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2SendEmailVerificationCode';
    ...
    */
    ...
    public function setUrlTemplate($urlTemplate)
    {
        ...
        if ((mb_strlen($urlTemplate) > 200)) {
            throw new \InvalidArgumentException('invalid length for $urlTemplate when calling Userv2SendEmailVerificationCode., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($urlTemplate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $urlTemplate when calling Userv2SendEmailVerificationCode., must be bigger than or equal to 1.');
        }
