...
/**
 * Userv2LDAPCredentials Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2LDAPCredentials implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2LDAPCredentials';
    ...
    */
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 200)) {
            throw new \InvalidArgumentException('invalid length for $username when calling Userv2LDAPCredentials., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling Userv2LDAPCredentials., must be bigger than or equal to 1.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 200)) {
            throw new \InvalidArgumentException('invalid length for $password when calling Userv2LDAPCredentials., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling Userv2LDAPCredentials., must be bigger than or equal to 1.');
        }
