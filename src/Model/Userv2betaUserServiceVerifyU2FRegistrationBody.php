...
/**
 * Userv2betaUserServiceVerifyU2FRegistrationBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2betaUserServiceVerifyU2FRegistrationBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2betaUserServiceVerifyU2FRegistrationBody';
    ...
    */
    ...
    public function setTokenName($tokenName)
    {
        ...
        if ((mb_strlen($tokenName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $tokenName when calling Userv2betaUserServiceVerifyU2FRegistrationBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($tokenName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tokenName when calling Userv2betaUserServiceVerifyU2FRegistrationBody., must be bigger than or equal to 1.');
        }
