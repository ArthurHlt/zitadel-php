...
/**
 * V3alphaSendWebAuthNRegistrationLink Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V3alphaSendWebAuthNRegistrationLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v3alphaSendWebAuthNRegistrationLink';
    ...
    */
    ...
    public function setUrlTemplate($urlTemplate)
    {
        ...
        if ((mb_strlen($urlTemplate) > 200)) {
            throw new \InvalidArgumentException('invalid length for $urlTemplate when calling V3alphaSendWebAuthNRegistrationLink., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($urlTemplate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $urlTemplate when calling V3alphaSendWebAuthNRegistrationLink., must be bigger than or equal to 1.');
        }
