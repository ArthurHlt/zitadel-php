...
/**
 * Userv2betaEmailQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class Userv2betaEmailQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2betaEmailQuery';
    ...
    */
    ...
    public function setEmailAddress($emailAddress)
    {
        ...
        if ((mb_strlen($emailAddress) > 200)) {
            throw new \InvalidArgumentException('invalid length for $emailAddress when calling Userv2betaEmailQuery., must be smaller than or equal to 200.');
        }
