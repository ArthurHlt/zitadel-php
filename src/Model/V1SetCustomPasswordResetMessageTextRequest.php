...
/**
 * V1SetCustomPasswordResetMessageTextRequest Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1SetCustomPasswordResetMessageTextRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1SetCustomPasswordResetMessageTextRequest';
    ...
    */
    ...
    public function setTitle($title)
    {
        ...
        if ((mb_strlen($title) > 500)) {
            throw new \InvalidArgumentException('invalid length for $title when calling V1SetCustomPasswordResetMessageTextRequest., must be smaller than or equal to 500.');
        }
    ...
    public function setPreHeader($preHeader)
    {
        ...
        if ((mb_strlen($preHeader) > 500)) {
            throw new \InvalidArgumentException('invalid length for $preHeader when calling V1SetCustomPasswordResetMessageTextRequest., must be smaller than or equal to 500.');
        }
    ...
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) > 500)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling V1SetCustomPasswordResetMessageTextRequest., must be smaller than or equal to 500.');
        }
    ...
    public function setGreeting($greeting)
    {
        ...
        if ((mb_strlen($greeting) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $greeting when calling V1SetCustomPasswordResetMessageTextRequest., must be smaller than or equal to 1000.');
        }
    ...
    public function setText($text)
    {
        ...
        if ((mb_strlen($text) > 10000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling V1SetCustomPasswordResetMessageTextRequest., must be smaller than or equal to 10000.');
        }
    ...
    public function setButtonText($buttonText)
    {
        ...
        if ((mb_strlen($buttonText) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $buttonText when calling V1SetCustomPasswordResetMessageTextRequest., must be smaller than or equal to 1000.');
        }
