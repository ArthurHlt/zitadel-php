...
/**
 * Userv2AddHumanUserRequest Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2AddHumanUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2AddHumanUserRequest';
    ...
    protected static $openAPITypes = [
        'userId' => 'string',
        'username' => 'string',
        'organization' => '\ArthurHlt\Zitadel\Model\Zitadelobjectv2Organization',
        'profile' => '\ArthurHlt\Zitadel\Model\Userv2SetHumanProfile',
        'email' => '\ArthurHlt\Zitadel\Model\Userv2SetHumanEmail',
        'phone' => '\ArthurHlt\Zitadel\Model\Userv2SetHumanPhone',
        'metadata' => '\ArthurHlt\Zitadel\Model\Userv2SetMetadataEntry[]',
        'password' => '\ArthurHlt\Zitadel\Model\Userv2Password',
        'hashedPassword' => '\ArthurHlt\Zitadel\Model\Userv2HashedPassword',
        'idpLinks' => '\ArthurHlt\Zitadel\Model\Userv2IDPLink[]',
        'totpSecret' => 'string'
    ];
    ...
    */
    ...
    public function setUserId($userId)
    {
        ...
        if ((mb_strlen($userId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $userId when calling Userv2AddHumanUserRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($userId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $userId when calling Userv2AddHumanUserRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 200)) {
            throw new \InvalidArgumentException('invalid length for $username when calling Userv2AddHumanUserRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling Userv2AddHumanUserRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets organization
     *
     * @return \ArthurHlt\Zitadel\Model\Zitadelobjectv2Organization|null
     */
     ...
     * Sets organization
     *
     * @param \ArthurHlt\Zitadel\Model\Zitadelobjectv2Organization|null $organization organization
     *
     * @return self
     */
     ...
     * Gets profile
     *
     * @return \ArthurHlt\Zitadel\Model\Userv2SetHumanProfile
     */
     ...
     * Sets profile
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2SetHumanProfile $profile profile
     *
     * @return self
     */
     ...
     * Gets email
     *
     * @return \ArthurHlt\Zitadel\Model\Userv2SetHumanEmail
     */
     ...
     * Sets email
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2SetHumanEmail $email email
     *
     * @return self
     */
     ...
     * Gets phone
     *
     * @return \ArthurHlt\Zitadel\Model\Userv2SetHumanPhone|null
     */
     ...
     * Sets phone
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2SetHumanPhone|null $phone phone
     *
     * @return self
     */
     ...
     * Gets metadata
     *
     * @return \ArthurHlt\Zitadel\Model\Userv2SetMetadataEntry[]|null
     */
     ...
     * Sets metadata
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2SetMetadataEntry[]|null $metadata metadata
     *
     * @return self
     */
     ...
     * Gets password
     *
     * @return \ArthurHlt\Zitadel\Model\Userv2Password|null
     */
     ...
     * Sets password
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2Password|null $password password
     *
     * @return self
     */
     ...
     * Gets hashedPassword
     *
     * @return \ArthurHlt\Zitadel\Model\Userv2HashedPassword|null
     */
     ...
     * Sets hashedPassword
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2HashedPassword|null $hashedPassword hashedPassword
     *
     * @return self
     */
     ...
     * Gets idpLinks
     *
     * @return \ArthurHlt\Zitadel\Model\Userv2IDPLink[]|null
     */
     ...
     * Sets idpLinks
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2IDPLink[]|null $idpLinks idpLinks
     *
     * @return self
     */
    ...
    public function setTotpSecret($totpSecret)
    {
        ...
        if ((mb_strlen($totpSecret) > 200)) {
            throw new \InvalidArgumentException('invalid length for $totpSecret when calling Userv2AddHumanUserRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($totpSecret) < 1)) {
            throw new \InvalidArgumentException('invalid length for $totpSecret when calling Userv2AddHumanUserRequest., must be bigger than or equal to 1.');
        }
