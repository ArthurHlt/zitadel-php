...
/**
 * Zitadeloidcv2Session Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Zitadeloidcv2Session implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'zitadeloidcv2Session';
    ...
    */
    ...
    public function setSessionId($sessionId)
    {
        ...
        if ((mb_strlen($sessionId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $sessionId when calling Zitadeloidcv2Session., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($sessionId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sessionId when calling Zitadeloidcv2Session., must be bigger than or equal to 1.');
        }
    ...
    public function setSessionToken($sessionToken)
    {
        ...
        if ((mb_strlen($sessionToken) > 200)) {
            throw new \InvalidArgumentException('invalid length for $sessionToken when calling Zitadeloidcv2Session., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($sessionToken) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sessionToken when calling Zitadeloidcv2Session., must be bigger than or equal to 1.');
        }
