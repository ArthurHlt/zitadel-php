...
/**
 * V1ManagementServiceUpdateAzureADProviderBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1ManagementServiceUpdateAzureADProviderBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1ManagementServiceUpdateAzureADProviderBody';
    ...
    protected static $openAPITypes = [
        ...
        'clientId' => 'string',
        'clientSecret' => 'string',
        'tenant' => '\ArthurHlt\Zitadel\Model\Idpv1AzureADTenant',
        'emailVerified' => 'bool',
        'scopes' => 'string[]',
    ...
    */
     ...
     * Sets clientId
     *
     * @param string|null $clientId Client id generated by the Azure AD
     *
     * @return self
     */
     ...
     * Sets clientSecret
     *
     * @param string|null $clientSecret Client_secret will only be updated if provided
     *
     * @return self
     */
     ...
     * Gets tenant
     *
     * @return \ArthurHlt\Zitadel\Model\Idpv1AzureADTenant|null
     */
     ...
     * Sets tenant
     *
     * @param \ArthurHlt\Zitadel\Model\Idpv1AzureADTenant|null $tenant tenant
     *
     * @return self
     */
     ...
     * Sets scopes
     *
     * @param string[]|null $scopes the scopes requested by ZITADEL during the request to Azure AD
     *
     * @return self
     */
