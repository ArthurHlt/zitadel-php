...
/**
 * V1WebAuthNKey Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1WebAuthNKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1WebAuthNKey';
    ...
    */
     ...
     * Sets publicKey
     *
     * @param string|null $publicKey json representation of public key credential creation options used by the webauthn client
     *
     * @return self
     */
    public function setPublicKey($publicKey)
    {
        ...
        if ((!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", ObjectSerializer::toString($publicKey)))) {
            throw new \InvalidArgumentException("invalid value for \$publicKey when calling V1WebAuthNKey., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
