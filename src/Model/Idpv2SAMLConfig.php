...
/**
 * Idpv2SAMLConfig Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Idpv2SAMLConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'idpv2SAMLConfig';
    ...
    protected static $openAPITypes = [
        'metadataXml' => 'string',
        'binding' => '\ArthurHlt\Zitadel\Model\Idpv2SAMLBinding',
        'withSignedRequest' => 'bool',
        'nameIdFormat' => '\ArthurHlt\Zitadel\Model\Idpv2SAMLNameIDFormat',
    ...
    */
    ...
    public function setMetadataXml($metadataXml)
    {
        ...
        if ((!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", ObjectSerializer::toString($metadataXml)))) {
            throw new \InvalidArgumentException("invalid value for \$metadataXml when calling Idpv2SAMLConfig., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
     ...
     * Gets binding
     *
     * @return \ArthurHlt\Zitadel\Model\Idpv2SAMLBinding|null
     */
     ...
     * Sets binding
     *
     * @param \ArthurHlt\Zitadel\Model\Idpv2SAMLBinding|null $binding binding
     *
     * @return self
     */
     ...
     * Gets nameIdFormat
     *
     * @return \ArthurHlt\Zitadel\Model\Idpv2SAMLNameIDFormat|null
     */
     ...
     * Sets nameIdFormat
     *
     * @param \ArthurHlt\Zitadel\Model\Idpv2SAMLNameIDFormat|null $nameIdFormat nameIdFormat
     *
     * @return self
     */
