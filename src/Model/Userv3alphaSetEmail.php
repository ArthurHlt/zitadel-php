...
/**
 * Userv3alphaSetEmail Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv3alphaSetEmail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv3alphaSetEmail';
    ...
    */
     ...
     * Sets address
     *
     * @param string $address Set the email address.
     *
     * @return self
     */
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) > 200)) {
            throw new \InvalidArgumentException('invalid length for $address when calling Userv3alphaSetEmail., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling Userv3alphaSetEmail., must be bigger than or equal to 1.');
        }
     ...
     * Sets isVerified
     *
     * @param bool|null $isVerified Set the email as already verified.
     *
     * @return self
     */
