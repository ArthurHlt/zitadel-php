...
/**
 * Userv2betaLoginNameQuery Class Doc Comment
 *
 * @category Class
 ...
 */
class Userv2betaLoginNameQuery implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2betaLoginNameQuery';
    ...
    */
    ...
    public function setLoginName($loginName)
    {
        ...
        if ((mb_strlen($loginName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $loginName when calling Userv2betaLoginNameQuery., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($loginName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $loginName when calling Userv2betaLoginNameQuery., must be bigger than or equal to 1.');
        }
