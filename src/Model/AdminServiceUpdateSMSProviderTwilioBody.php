...
/**
 * AdminServiceUpdateSMSProviderTwilioBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class AdminServiceUpdateSMSProviderTwilioBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdminServiceUpdateSMSProviderTwilioBody';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['senderNumber']) && (mb_strlen($this->container['senderNumber']) < 1)) {
            $invalidProperties[] = "invalid value for 'senderNumber', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setSid($sid)
    {
        ...
        if ((mb_strlen($sid) > 200)) {
            throw new \InvalidArgumentException('invalid length for $sid when calling AdminServiceUpdateSMSProviderTwilioBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($sid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sid when calling AdminServiceUpdateSMSProviderTwilioBody., must be bigger than or equal to 1.');
        }
    ...
    public function setSenderNumber($senderNumber)
    {
        ...
        if ((mb_strlen($senderNumber) > 200)) {
            throw new \InvalidArgumentException('invalid length for $senderNumber when calling AdminServiceUpdateSMSProviderTwilioBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($senderNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $senderNumber when calling AdminServiceUpdateSMSProviderTwilioBody., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AdminServiceUpdateSMSProviderTwilioBody., must be smaller than or equal to 200.');
        }
    ...
    public function setVerifyServiceSid($verifyServiceSid)
    {
        ...
        if ((mb_strlen($verifyServiceSid) > 200)) {
            throw new \InvalidArgumentException('invalid length for $verifyServiceSid when calling AdminServiceUpdateSMSProviderTwilioBody., must be smaller than or equal to 200.');
        }
