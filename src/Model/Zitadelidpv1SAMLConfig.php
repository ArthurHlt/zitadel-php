...
/**
 * Zitadelidpv1SAMLConfig Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Zitadelidpv1SAMLConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'zitadelidpv1SAMLConfig';
    ...
    */
    ...
    public function setMetadataXml($metadataXml)
    {
        ...
        if ((!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", ObjectSerializer::toString($metadataXml)))) {
            throw new \InvalidArgumentException("invalid value for \$metadataXml when calling Zitadelidpv1SAMLConfig., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
