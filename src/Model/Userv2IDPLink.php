...
/**
 * Userv2IDPLink Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2IDPLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2IDPLink';
    ...
    */
    ...
    public function setIdpId($idpId)
    {
        ...
        if ((mb_strlen($idpId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $idpId when calling Userv2IDPLink., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($idpId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $idpId when calling Userv2IDPLink., must be bigger than or equal to 1.');
        }
    ...
    public function setUserId($userId)
    {
        ...
        if ((mb_strlen($userId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $userId when calling Userv2IDPLink., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($userId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $userId when calling Userv2IDPLink., must be bigger than or equal to 1.');
        }
    ...
    public function setUserName($userName)
    {
        ...
        if ((mb_strlen($userName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $userName when calling Userv2IDPLink., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($userName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $userName when calling Userv2IDPLink., must be bigger than or equal to 1.');
        }
