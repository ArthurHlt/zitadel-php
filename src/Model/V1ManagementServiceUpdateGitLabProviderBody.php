...
/**
 * V1ManagementServiceUpdateGitLabProviderBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1ManagementServiceUpdateGitLabProviderBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1ManagementServiceUpdateGitLabProviderBody';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name GitLab will be used as default, if no name is provided
     *
     * @return self
     */
     ...
     * Sets clientId
     *
     * @param string|null $clientId Client id generated by GitLab
     *
     * @return self
     */
     ...
     * Sets clientSecret
     *
     * @param string|null $clientSecret Client secret will only be updated if provided
     *
     * @return self
     */
     ...
     * Sets scopes
     *
     * @param string[]|null $scopes The scopes requested by ZITADEL during the request to GitLab
     *
     * @return self
     */
