...
/**
 * V1PasswordAgePolicy Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1PasswordAgePolicy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1PasswordAgePolicy';
    ...
    */
     ...
     * Sets isDefault
     *
     * @param bool|null $isDefault If true, the returned values represent the instance settings, e.g. by an organization without custom settings.
     *
     * @return self
     */
