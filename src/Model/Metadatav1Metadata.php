...
/**
 * Metadatav1Metadata Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Metadatav1Metadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'metadatav1Metadata';
    ...
    */
     ...
     * Sets key
     *
     * @param string|null $key metadata key
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value metadata value is base64 encoded, make sure to decode to get the value
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", ObjectSerializer::toString($value)))) {
            throw new \InvalidArgumentException("invalid value for \$value when calling Metadatav1Metadata., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
