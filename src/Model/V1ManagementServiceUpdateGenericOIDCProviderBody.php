...
/**
 * V1ManagementServiceUpdateGenericOIDCProviderBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1ManagementServiceUpdateGenericOIDCProviderBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1ManagementServiceUpdateGenericOIDCProviderBody';
    ...
    */
     ...
     *
     * @param bool|null $isIdTokenMapping isIdTokenMapping
     *
     * @return self
     */
     ...
     * Sets usePkce
     *
     * @param bool|null $usePkce Enable the use of Proof Key for Code Exchange (PKCE) for the OIDC flow.
     *
     * @return self
     */
