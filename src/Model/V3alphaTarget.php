...
/**
 * V3alphaTarget Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V3alphaTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v3alphaTarget';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $name when calling V3alphaTarget., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling V3alphaTarget., must be bigger than or equal to 1.');
        }
    ...
    public function setEndpoint($endpoint)
    {
        ...
        if ((mb_strlen($endpoint) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling V3alphaTarget., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($endpoint) < 1)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling V3alphaTarget., must be bigger than or equal to 1.');
        }
