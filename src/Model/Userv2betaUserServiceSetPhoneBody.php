...
/**
 * Userv2betaUserServiceSetPhoneBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2betaUserServiceSetPhoneBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2betaUserServiceSetPhoneBody';
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 200)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Userv2betaUserServiceSetPhoneBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Userv2betaUserServiceSetPhoneBody., must be bigger than or equal to 1.');
        }
