...
/**
 * Zitadelorgv2Organization Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Zitadelorgv2Organization implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'zitadelorgv2Organization';
    ...
    protected static $openAPITypes = [
        ...
        'state' => '\ArthurHlt\Zitadel\Model\V2OrganizationState',
        'name' => 'string',
    ...
    */
     ...
     * Gets state
     *
     * @return \ArthurHlt\Zitadel\Model\V2OrganizationState|null
     */
     ...
     * Sets state
     *
     * @param \ArthurHlt\Zitadel\Model\V2OrganizationState|null $state state
     *
     * @return self
     */
     ...
     * Sets primaryDomain
     *
     * @param string|null $primaryDomain Primary domain used in the organization.
     *
     * @return self
     */
    public function setPrimaryDomain($primaryDomain)
    {
        if (is_null($primaryDomain)) {
            throw new \InvalidArgumentException('non-nullable primaryDomain cannot be null');
        }
