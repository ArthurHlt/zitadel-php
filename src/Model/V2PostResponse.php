...
/**
 * V2PostResponse Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V2PostResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v2PostResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('samlResponse', $data ?? [], null);
    }
    ...
    */
    ...
    public function setSamlResponse($samlResponse)
    {
        if (is_null($samlResponse)) {
            throw new \InvalidArgumentException('non-nullable samlResponse cannot be null');
        }
