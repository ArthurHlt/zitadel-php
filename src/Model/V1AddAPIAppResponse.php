...
/**
 * V1AddAPIAppResponse Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1AddAPIAppResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1AddAPIAppResponse';
    ...
    */
     ...
     * Sets clientId
     *
     * @param string|null $clientId generated secret for this config
     *
     * @return self
     */
