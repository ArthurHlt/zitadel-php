...
/**
 * Userv2betaUserServiceVerifyPasskeyRegistrationBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2betaUserServiceVerifyPasskeyRegistrationBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2betaUserServiceVerifyPasskeyRegistrationBody';
    ...
    */
    ...
    public function setPasskeyName($passkeyName)
    {
        ...
        if ((mb_strlen($passkeyName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $passkeyName when calling Userv2betaUserServiceVerifyPasskeyRegistrationBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($passkeyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $passkeyName when calling Userv2betaUserServiceVerifyPasskeyRegistrationBody., must be bigger than or equal to 1.');
        }
