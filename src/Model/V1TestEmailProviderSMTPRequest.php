...
/**
 * V1TestEmailProviderSMTPRequest Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1TestEmailProviderSMTPRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1TestEmailProviderSMTPRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['receiverAddress'] === null) {
            $invalidProperties[] = "'receiverAddress' can't be null";
        }
        if ((mb_strlen($this->container['receiverAddress']) > 200)) {
            $invalidProperties[] = "invalid value for 'receiverAddress', the character length must be smaller than or equal to 200.";
        }

        if ((mb_strlen($this->container['receiverAddress']) < 1)) {
            $invalidProperties[] = "invalid value for 'receiverAddress', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setSenderAddress($senderAddress)
    {
        ...
        if ((mb_strlen($senderAddress) > 200)) {
            throw new \InvalidArgumentException('invalid length for $senderAddress when calling V1TestEmailProviderSMTPRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($senderAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $senderAddress when calling V1TestEmailProviderSMTPRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSenderName($senderName)
    {
        ...
        if ((mb_strlen($senderName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $senderName when calling V1TestEmailProviderSMTPRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($senderName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $senderName when calling V1TestEmailProviderSMTPRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setHost($host)
    {
        ...
        if ((mb_strlen($host) > 500)) {
            throw new \InvalidArgumentException('invalid length for $host when calling V1TestEmailProviderSMTPRequest., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($host) < 1)) {
            throw new \InvalidArgumentException('invalid length for $host when calling V1TestEmailProviderSMTPRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setReceiverAddress($receiverAddress)
    {
        ...
        if ((mb_strlen($receiverAddress) > 200)) {
            throw new \InvalidArgumentException('invalid length for $receiverAddress when calling V1TestEmailProviderSMTPRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($receiverAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $receiverAddress when calling V1TestEmailProviderSMTPRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets id
     *
     * @param string|null $id Zitadel SMTP provider id in case you are not sending the password and want to reuse the stored password
     *
     * @return self
     */
