...
/**
 * Oidcv2betaAuthRequest Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Oidcv2betaAuthRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'oidcv2betaAuthRequest';
    ...
    protected static $openAPITypes = [
        ...
        'scope' => 'string[]',
        'redirectUri' => 'string',
        'prompt' => '\ArthurHlt\Zitadel\Model\Oidcv2betaPrompt[]',
        'uiLocales' => 'string[]',
        'loginHint' => 'string',
        'maxAge' => 'string',
        'hintUserId' => 'string'
    ...
    */
     ...
     * Gets prompt
     *
     * @return \ArthurHlt\Zitadel\Model\Oidcv2betaPrompt[]|null
     */
     ...
     * Sets prompt
     *
     * @param \ArthurHlt\Zitadel\Model\Oidcv2betaPrompt[]|null $prompt Prompts that must be displayed to the user
     *
     * @return self
     */
