...
/**
 * V1CreateInstanceRequestPassword Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1CreateInstanceRequestPassword implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1CreateInstanceRequestPassword';
    ...
    */
     ...
     *
     * @param bool|null $passwordChangeRequired passwordChangeRequired
     *
     * @return self
     */
