...
/**
 * Zitadelmanagementv1AddGenericOAuthProviderRequest Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Zitadelmanagementv1AddGenericOAuthProviderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'zitadelmanagementv1AddGenericOAuthProviderRequest';
    ...
    */
     ...
     * Sets clientSecret
     *
     * @param string|null $clientSecret Client secret generated by the identity provider
     *
     * @return self
     */
     ...
     * Sets idAttribute
     *
     * @param string|null $idAttribute Identifying attribute of the user in the response of the user_endpoint
     *
     * @return self
     */
     ...
     * Sets usePkce
     *
     * @param bool|null $usePkce Enable the use of Proof Key for Code Exchange (PKCE) for the OAuth2 flow.
     *
     * @return self
     */
