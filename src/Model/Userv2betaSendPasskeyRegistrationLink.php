...
/**
 * Userv2betaSendPasskeyRegistrationLink Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2betaSendPasskeyRegistrationLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2betaSendPasskeyRegistrationLink';
    ...
    */
     ...
     * Sets urlTemplate
     *
     * @param string|null $urlTemplate \"Optionally set a url_template, which will be used in the mail sent by ZITADEL to guide the user to your passkey registration page. If no template is set, the default ZITADEL url will be used.\"
     *
     * @return self
     */
    public function setUrlTemplate($urlTemplate)
    {
        ...
        if ((mb_strlen($urlTemplate) > 200)) {
            throw new \InvalidArgumentException('invalid length for $urlTemplate when calling Userv2betaSendPasskeyRegistrationLink., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($urlTemplate) < 1)) {
            throw new \InvalidArgumentException('invalid length for $urlTemplate when calling Userv2betaSendPasskeyRegistrationLink., must be bigger than or equal to 1.');
        }
