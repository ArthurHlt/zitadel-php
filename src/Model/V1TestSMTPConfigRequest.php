...
/**
 * V1TestSMTPConfigRequest Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1TestSMTPConfigRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1TestSMTPConfigRequest';
    ...
    */
    ...
    public function setSenderAddress($senderAddress)
    {
        ...
        if ((mb_strlen($senderAddress) > 200)) {
            throw new \InvalidArgumentException('invalid length for $senderAddress when calling V1TestSMTPConfigRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($senderAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $senderAddress when calling V1TestSMTPConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSenderName($senderName)
    {
        ...
        if ((mb_strlen($senderName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $senderName when calling V1TestSMTPConfigRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($senderName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $senderName when calling V1TestSMTPConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setHost($host)
    {
        ...
        if ((mb_strlen($host) > 500)) {
            throw new \InvalidArgumentException('invalid length for $host when calling V1TestSMTPConfigRequest., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($host) < 1)) {
            throw new \InvalidArgumentException('invalid length for $host when calling V1TestSMTPConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setReceiverAddress($receiverAddress)
    {
        ...
        if ((mb_strlen($receiverAddress) > 200)) {
            throw new \InvalidArgumentException('invalid length for $receiverAddress when calling V1TestSMTPConfigRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($receiverAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $receiverAddress when calling V1TestSMTPConfigRequest., must be bigger than or equal to 1.');
        }
