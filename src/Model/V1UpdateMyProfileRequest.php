...
/**
 * V1UpdateMyProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1UpdateMyProfileRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1UpdateMyProfileRequest';
    ...
    */
    ...
    public function setFirstName($firstName)
    {
        ...
        if ((mb_strlen($firstName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling V1UpdateMyProfileRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($firstName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling V1UpdateMyProfileRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($lastName)
    {
        ...
        if ((mb_strlen($lastName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling V1UpdateMyProfileRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($lastName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling V1UpdateMyProfileRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setNickName($nickName)
    {
        ...
        if ((mb_strlen($nickName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $nickName when calling V1UpdateMyProfileRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($nickName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nickName when calling V1UpdateMyProfileRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDisplayName($displayName)
    {
        ...
        if ((mb_strlen($displayName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling V1UpdateMyProfileRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($displayName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling V1UpdateMyProfileRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPreferredLanguage($preferredLanguage)
    {
        ...
        if ((mb_strlen($preferredLanguage) > 10)) {
            throw new \InvalidArgumentException('invalid length for $preferredLanguage when calling V1UpdateMyProfileRequest., must be smaller than or equal to 10.');
        }
