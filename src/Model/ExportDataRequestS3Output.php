...
/**
 * ExportDataRequestS3Output Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class ExportDataRequestS3Output implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExportDataRequestS3Output';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('secretAccessKey', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $secretAccessKey secretAccessKey
     *
     * @return self
     */
    public function setSecretAccessKey($secretAccessKey)
    {
        if (is_null($secretAccessKey)) {
            throw new \InvalidArgumentException('non-nullable secretAccessKey cannot be null');
        }
