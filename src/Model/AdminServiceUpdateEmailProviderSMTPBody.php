...
/**
 * AdminServiceUpdateEmailProviderSMTPBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class AdminServiceUpdateEmailProviderSMTPBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdminServiceUpdateEmailProviderSMTPBody';
    ...
    */
    ...
    public function setSenderAddress($senderAddress)
    {
        ...
        if ((mb_strlen($senderAddress) > 200)) {
            throw new \InvalidArgumentException('invalid length for $senderAddress when calling AdminServiceUpdateEmailProviderSMTPBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($senderAddress) < 1)) {
            throw new \InvalidArgumentException('invalid length for $senderAddress when calling AdminServiceUpdateEmailProviderSMTPBody., must be bigger than or equal to 1.');
        }
    ...
    public function setSenderName($senderName)
    {
        ...
        if ((mb_strlen($senderName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $senderName when calling AdminServiceUpdateEmailProviderSMTPBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($senderName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $senderName when calling AdminServiceUpdateEmailProviderSMTPBody., must be bigger than or equal to 1.');
        }
    ...
    public function setHost($host)
    {
        ...
        if ((mb_strlen($host) > 500)) {
            throw new \InvalidArgumentException('invalid length for $host when calling AdminServiceUpdateEmailProviderSMTPBody., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($host) < 1)) {
            throw new \InvalidArgumentException('invalid length for $host when calling AdminServiceUpdateEmailProviderSMTPBody., must be bigger than or equal to 1.');
        }
    ...
    public function setReplyToAddress($replyToAddress)
    {
        ...
        if ((mb_strlen($replyToAddress) > 200)) {
            throw new \InvalidArgumentException('invalid length for $replyToAddress when calling AdminServiceUpdateEmailProviderSMTPBody., must be smaller than or equal to 200.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AdminServiceUpdateEmailProviderSMTPBody., must be smaller than or equal to 200.');
        }
