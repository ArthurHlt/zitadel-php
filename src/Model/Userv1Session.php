...
/**
 * Userv1Session Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv1Session implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv1Session';
    ...
    protected static $openAPITypes = [
        'sessionId' => 'string',
        'agentId' => 'string',
        'authState' => '\ArthurHlt\Zitadel\Model\V1SessionState',
        'userId' => 'string',
        'userName' => 'string',
        'loginName' => 'string',
        'displayName' => 'string',
    ...
    */
     ...
     * Sets agentId
     *
     * @param string|null $agentId agentId
     *
     * @return self
     */
     ...
     * Gets authState
     *
     * @return \ArthurHlt\Zitadel\Model\V1SessionState|null
     */
     ...
     * Sets authState
     *
     * @param \ArthurHlt\Zitadel\Model\V1SessionState|null $authState authState
     *
     * @return self
     */
    public function setAuthState($authState)
    {
        if (is_null($authState)) {
            throw new \InvalidArgumentException('non-nullable authState cannot be null');
        }
