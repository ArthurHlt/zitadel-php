...
/**
 * Userv3alphaSetPassword Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv3alphaSetPassword implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv3alphaSetPassword';
    ...
    protected static $setters = [
        ...
        'hash' => 'setHash',
        'changeRequired' => 'setChangeRequired',
    ...
    protected static $getters = [
        ...
        'hash' => 'getHash',
        'changeRequired' => 'getChangeRequired',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('changeRequired', $data ?? [], null);
    ...
    */
     ...
     * Sets password
     *
     * @param string $password Provide the plain text password. ZITADEL will take care to store it in a secure way (hash).
     *
     * @return self
     */
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 200)) {
            throw new \InvalidArgumentException('invalid length for $password when calling Userv3alphaSetPassword., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling Userv3alphaSetPassword., must be bigger than or equal to 1.');
        }
    ...
    public function setHash($hash)
    {
        ...
        if ((mb_strlen($hash) > 200)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling Userv3alphaSetPassword., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($hash) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hash when calling Userv3alphaSetPassword., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['changeRequired'];
    }

    /**
     * Sets changeRequired
     *
     * @param bool|null $changeRequired Provide if the user needs to change the password on the next use.
     *
     * @return self
     */
    public function setChangeRequired($changeRequired)
    {
        if (is_null($changeRequired)) {
            throw new \InvalidArgumentException('non-nullable changeRequired cannot be null');
        }
        $this->container['changeRequired'] = $changeRequired;
     ...
     *
     * @param string $currentPassword Provide the current password to verify you're allowed to change the password.
     *
     * @return self
     */
    public function setCurrentPassword($currentPassword)
    {
        ...
        if ((mb_strlen($currentPassword) > 200)) {
            throw new \InvalidArgumentException('invalid length for $currentPassword when calling Userv3alphaSetPassword., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($currentPassword) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currentPassword when calling Userv3alphaSetPassword., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $verificationCode Or provider the verification code generated during password reset request.
     *
     * @return self
     */
    public function setVerificationCode($verificationCode)
    {
        ...
        if ((mb_strlen($verificationCode) > 20)) {
            throw new \InvalidArgumentException('invalid length for $verificationCode when calling Userv3alphaSetPassword., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($verificationCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $verificationCode when calling Userv3alphaSetPassword., must be bigger than or equal to 1.');
        }
