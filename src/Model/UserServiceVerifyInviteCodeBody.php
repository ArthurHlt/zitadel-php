...
/**
 * UserServiceVerifyInviteCodeBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class UserServiceVerifyInviteCodeBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserServiceVerifyInviteCodeBody';
    ...
    */
     ...
     *
     * @param string $verificationCode \"the verification code generated during the invite code request\"
     *
     * @return self
     */
    public function setVerificationCode($verificationCode)
    {
        ...
        if ((mb_strlen($verificationCode) > 20)) {
            throw new \InvalidArgumentException('invalid length for $verificationCode when calling UserServiceVerifyInviteCodeBody., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($verificationCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $verificationCode when calling UserServiceVerifyInviteCodeBody., must be bigger than or equal to 1.');
        }
