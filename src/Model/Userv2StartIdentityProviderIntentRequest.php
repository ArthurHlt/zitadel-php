...
/**
 * Userv2StartIdentityProviderIntentRequest Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2StartIdentityProviderIntentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2StartIdentityProviderIntentRequest';
    ...
    protected static $openAPITypes = [
        'idpId' => 'string',
        'urls' => '\ArthurHlt\Zitadel\Model\Userv2RedirectURLs',
        'ldap' => '\ArthurHlt\Zitadel\Model\Userv2LDAPCredentials'
    ];
    ...
    */
    ...
    public function setIdpId($idpId)
    {
        ...
        if ((mb_strlen($idpId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $idpId when calling Userv2StartIdentityProviderIntentRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($idpId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $idpId when calling Userv2StartIdentityProviderIntentRequest., must be bigger than or equal to 1.');
        }
     ...
     * Gets urls
     *
     * @return \ArthurHlt\Zitadel\Model\Userv2RedirectURLs|null
     */
     ...
     * Sets urls
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2RedirectURLs|null $urls urls
     *
     * @return self
     */
     ...
     * Gets ldap
     *
     * @return \ArthurHlt\Zitadel\Model\Userv2LDAPCredentials|null
     */
     ...
     * Sets ldap
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2LDAPCredentials|null $ldap ldap
     *
     * @return self
     */
