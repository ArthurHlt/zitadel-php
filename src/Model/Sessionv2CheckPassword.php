...
/**
 * Sessionv2CheckPassword Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Sessionv2CheckPassword implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sessionv2CheckPassword';
    ...
    */
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 200)) {
            throw new \InvalidArgumentException('invalid length for $password when calling Sessionv2CheckPassword., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling Sessionv2CheckPassword., must be bigger than or equal to 1.');
        }
