...
/**
 * Userv2UserServiceSetPasswordBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2UserServiceSetPasswordBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2UserServiceSetPasswordBody';
    ...
    protected static $openAPITypes = [
        'newPassword' => '\ArthurHlt\Zitadel\Model\Userv2Password',
    ...
    */
     ...
     * Sets newPassword
     *
     * @param \ArthurHlt\Zitadel\Model\Userv2Password|null $newPassword newPassword
     *
     * @return self
     */
    ...
    public function setCurrentPassword($currentPassword)
    {
        ...
        if ((mb_strlen($currentPassword) > 200)) {
            throw new \InvalidArgumentException('invalid length for $currentPassword when calling Userv2UserServiceSetPasswordBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($currentPassword) < 1)) {
            throw new \InvalidArgumentException('invalid length for $currentPassword when calling Userv2UserServiceSetPasswordBody., must be bigger than or equal to 1.');
        }
    ...
    public function setVerificationCode($verificationCode)
    {
        ...
        if ((mb_strlen($verificationCode) > 20)) {
            throw new \InvalidArgumentException('invalid length for $verificationCode when calling Userv2UserServiceSetPasswordBody., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($verificationCode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $verificationCode when calling Userv2UserServiceSetPasswordBody., must be bigger than or equal to 1.');
        }
