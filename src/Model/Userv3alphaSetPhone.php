...
/**
 * Userv3alphaSetPhone Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv3alphaSetPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv3alphaSetPhone';
    ...
    */
     ...
     * Sets number
     *
     * @param string $number Set the user's phone number.
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $number when calling Userv3alphaSetPhone., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling Userv3alphaSetPhone., must be bigger than or equal to 1.');
        }
     ...
     * Sets isVerified
     *
     * @param bool|null $isVerified Set the phone as already verified.
     *
     * @return self
     */
