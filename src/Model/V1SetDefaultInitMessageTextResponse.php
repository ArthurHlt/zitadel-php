...
/**
 * V1SetDefaultInitMessageTextResponse Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1SetDefaultInitMessageTextResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1SetDefaultInitMessageTextResponse';
