...
/**
 * Actionv3alphaPatchTarget Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Actionv3alphaPatchTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'actionv3alphaPatchTarget';
    ...
    protected static $openAPITypes = [
        'name' => 'string',
        'restWebhook' => '\ArthurHlt\Zitadel\Model\V3alphaSetRESTWebhook',
        'restCall' => '\ArthurHlt\Zitadel\Model\V3alphaSetRESTCall',
        'restAsync' => 'object',
        'timeout' => 'string',
        'endpoint' => 'string',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Actionv3alphaPatchTarget., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Actionv3alphaPatchTarget., must be bigger than or equal to 1.');
        }
     ...
     * Gets restWebhook
     *
     * @return \ArthurHlt\Zitadel\Model\V3alphaSetRESTWebhook|null
     */
     ...
     * Sets restWebhook
     *
     * @param \ArthurHlt\Zitadel\Model\V3alphaSetRESTWebhook|null $restWebhook restWebhook
     *
     * @return self
     */
     ...
     * Gets restCall
     *
     * @return \ArthurHlt\Zitadel\Model\V3alphaSetRESTCall|null
     */
     ...
     * Sets restCall
     *
     * @param \ArthurHlt\Zitadel\Model\V3alphaSetRESTCall|null $restCall restCall
     *
     * @return self
     */
     ...
     * Sets restAsync
     *
     * @param object|null $restAsync Call is executed in parallel to others, ZITADEL does not wait until the call is finished. The state is ignored, call is sent as post.
     *
     * @return self
     */
     ...
     * Sets timeout
     *
     * @param string|null $timeout if the target doesn't respond before this timeout expires, the the connection is closed and the action fails
     *
     * @return self
     */
    ...
    public function setEndpoint($endpoint)
    {
        ...
        if ((mb_strlen($endpoint) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling Actionv3alphaPatchTarget., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($endpoint) < 1)) {
            throw new \InvalidArgumentException('invalid length for $endpoint when calling Actionv3alphaPatchTarget., must be bigger than or equal to 1.');
        }
