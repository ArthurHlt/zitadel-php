...
/**
 * Zitadelmanagementv1AddGoogleProviderRequest Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Zitadelmanagementv1AddGoogleProviderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'zitadelmanagementv1AddGoogleProviderRequest';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Google will be used as default, if no name is provided
     *
     * @return self
     */
     ...
     * Sets clientId
     *
     * @param string|null $clientId Client id generated by Google
     *
     * @return self
     */
     ...
     * Sets clientSecret
     *
     * @param string|null $clientSecret Client secret generated by Google
     *
     * @return self
     */
     ...
     * Sets scopes
     *
     * @param string[]|null $scopes The scopes requested by ZITADEL during the request to Google
     *
     * @return self
     */
