...
/**
 * V1ObjectDetails Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1ObjectDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1ObjectDetails';
    ...
    */
     ...
     * Sets sequence
     *
     * @param string|null $sequence on read: the sequence of the last event reduced by the projection  on manipulation: the timestamp of the event(s) added by the manipulation
     *
     * @return self
     */
     ...
     * Sets creationDate
     *
     * @param \DateTime|null $creationDate on read: the timestamp of the first event of the object  on create: the timestamp of the event(s) added by the manipulation
     *
     * @return self
     */
     ...
     * Sets changeDate
     *
     * @param \DateTime|null $changeDate on read: the timestamp of the last event reduced by the projection  on manipulation: the
     *
     * @return self
     */
