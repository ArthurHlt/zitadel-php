...
/**
 * Sessionv2CheckIDPIntent Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Sessionv2CheckIDPIntent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sessionv2CheckIDPIntent';
    ...
    */
    ...
    public function setIdpIntentId($idpIntentId)
    {
        ...
        if ((mb_strlen($idpIntentId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $idpIntentId when calling Sessionv2CheckIDPIntent., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($idpIntentId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $idpIntentId when calling Sessionv2CheckIDPIntent., must be bigger than or equal to 1.');
        }
    ...
    public function setIdpIntentToken($idpIntentToken)
    {
        ...
        if ((mb_strlen($idpIntentToken) > 200)) {
            throw new \InvalidArgumentException('invalid length for $idpIntentToken when calling Sessionv2CheckIDPIntent., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($idpIntentToken) < 1)) {
            throw new \InvalidArgumentException('invalid length for $idpIntentToken when calling Sessionv2CheckIDPIntent., must be bigger than or equal to 1.');
        }
