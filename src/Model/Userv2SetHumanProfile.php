...
/**
 * Userv2SetHumanProfile Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2SetHumanProfile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2SetHumanProfile';
    ...
    */
    ...
    public function setGivenName($givenName)
    {
        ...
        if ((mb_strlen($givenName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $givenName when calling Userv2SetHumanProfile., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($givenName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $givenName when calling Userv2SetHumanProfile., must be bigger than or equal to 1.');
        }
    ...
    public function setFamilyName($familyName)
    {
        ...
        if ((mb_strlen($familyName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $familyName when calling Userv2SetHumanProfile., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($familyName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $familyName when calling Userv2SetHumanProfile., must be bigger than or equal to 1.');
        }
    ...
    public function setNickName($nickName)
    {
        ...
        if ((mb_strlen($nickName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $nickName when calling Userv2SetHumanProfile., must be smaller than or equal to 200.');
        }
    ...
    public function setDisplayName($displayName)
    {
        ...
        if ((mb_strlen($displayName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $displayName when calling Userv2SetHumanProfile., must be smaller than or equal to 200.');
        }
    ...
    public function setPreferredLanguage($preferredLanguage)
    {
        ...
        if ((mb_strlen($preferredLanguage) > 10)) {
            throw new \InvalidArgumentException('invalid length for $preferredLanguage when calling Userv2SetHumanProfile., must be smaller than or equal to 10.');
        }
