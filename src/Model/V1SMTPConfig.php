...
/**
 * V1SMTPConfig Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1SMTPConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1SMTPConfig';
    ...
    protected static $openAPITypes = [
        ...
        'state' => '\ArthurHlt\Zitadel\Model\V1SMTPConfigState',
        'description' => 'string',
        'id' => 'string'
    ];
    ...
    */
     ...
     * Sets senderAddress
     *
     * @param string|null $senderAddress senderAddress
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \ArthurHlt\Zitadel\Model\V1SMTPConfigState|null
     */
     ...
     * Sets state
     *
     * @param \ArthurHlt\Zitadel\Model\V1SMTPConfigState|null $state state
     *
     * @return self
     */
