...
/**
 * V1ManagementServiceUpdateSAMLProviderBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1ManagementServiceUpdateSAMLProviderBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1ManagementServiceUpdateSAMLProviderBody';
    ...
    */
    ...
    public function setMetadataXml($metadataXml)
    {
        ...
        if ((!preg_match("/^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/", ObjectSerializer::toString($metadataXml)))) {
            throw new \InvalidArgumentException("invalid value for \$metadataXml when calling V1ManagementServiceUpdateSAMLProviderBody., must conform to the pattern /^(?:[A-Za-z0-9+\/]{4})*(?:[A-Za-z0-9+\/]{2}==|[A-Za-z0-9+\/]{3}=)?$/.");
        }
