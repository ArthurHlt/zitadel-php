...
/**
 * V3alphaIdentityProviderIntent Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V3alphaIdentityProviderIntent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v3alphaIdentityProviderIntent';
    ...
    */
     ...
     * Sets idpIntentId
     *
     * @param string|null $idpIntentId ID of the identity provider (IDP) intent.
     *
     * @return self
     */
     ...
     * Sets idpIntentToken
     *
     * @param string|null $idpIntentToken Token of the identity provider (IDP) intent.
     *
     * @return self
     */
     ...
     * Sets userId
     *
     * @param string|null $userId If the user was already federated and linked to a ZITADEL user, it's id will be returned.
     *
     * @return self
     */
