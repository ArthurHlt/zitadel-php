...
/**
 * Userv2IDPIntent Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2IDPIntent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2IDPIntent';
    ...
    */
    ...
    public function setIdpIntentId($idpIntentId)
    {
        ...
        if ((mb_strlen($idpIntentId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $idpIntentId when calling Userv2IDPIntent., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($idpIntentId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $idpIntentId when calling Userv2IDPIntent., must be bigger than or equal to 1.');
        }
    ...
    public function setIdpIntentToken($idpIntentToken)
    {
        ...
        if ((mb_strlen($idpIntentToken) > 200)) {
            throw new \InvalidArgumentException('invalid length for $idpIntentToken when calling Userv2IDPIntent., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($idpIntentToken) < 1)) {
            throw new \InvalidArgumentException('invalid length for $idpIntentToken when calling Userv2IDPIntent., must be bigger than or equal to 1.');
        }
    ...
    public function setUserId($userId)
    {
        ...
        if ((mb_strlen($userId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $userId when calling Userv2IDPIntent., must be smaller than or equal to 200.');
        }
