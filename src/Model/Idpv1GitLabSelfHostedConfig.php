...
/**
 * Idpv1GitLabSelfHostedConfig Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Idpv1GitLabSelfHostedConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'idpv1GitLabSelfHostedConfig';
    ...
    */
     ...
     * Sets clientId
     *
     * @param string|null $clientId client id of the GitLab application
     *
     * @return self
     */
