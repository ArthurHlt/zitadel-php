...
/**
 * Sessionv2CheckUser Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Sessionv2CheckUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sessionv2CheckUser';
    ...
    */
    ...
    public function setUserId($userId)
    {
        ...
        if ((mb_strlen($userId) > 200)) {
            throw new \InvalidArgumentException('invalid length for $userId when calling Sessionv2CheckUser., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($userId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $userId when calling Sessionv2CheckUser., must be bigger than or equal to 1.');
        }
    ...
    public function setLoginName($loginName)
    {
        ...
        if ((mb_strlen($loginName) > 200)) {
            throw new \InvalidArgumentException('invalid length for $loginName when calling Sessionv2CheckUser., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($loginName) < 1)) {
            throw new \InvalidArgumentException('invalid length for $loginName when calling Sessionv2CheckUser., must be bigger than or equal to 1.');
        }
