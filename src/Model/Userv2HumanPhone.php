...
/**
 * Userv2HumanPhone Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Userv2HumanPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'userv2HumanPhone';
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 200)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Userv2HumanPhone., must be smaller than or equal to 200.');
        }
