...
/**
 * AdminServiceUpdateIDPBody Class Doc Comment
 *
 * @category Class
 ...
 */
class AdminServiceUpdateIDPBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdminServiceUpdateIDPBody';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AdminServiceUpdateIDPBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AdminServiceUpdateIDPBody., must be bigger than or equal to 1.');
        }
