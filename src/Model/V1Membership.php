...
/**
 * V1Membership Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class V1Membership implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1Membership';
    ...
    */
     ...
     * Sets iam
     *
     * @param bool|null $iam one of type use iam, org id, project id or project grant id
     *
     * @return self
     */
     ...
     * Sets orgId
     *
     * @param string|null $orgId one of type use iam, org id, project id or project grant id
     *
     * @return self
     */
     ...
     * Sets projectId
     *
     * @param string|null $projectId one of type use iam, org id, project id or project grant id
     *
     * @return self
     */
     ...
     * Sets projectGrantId
     *
     * @param string|null $projectGrantId one of type use iam, org id, project id or project grant id
     *
     * @return self
     */
