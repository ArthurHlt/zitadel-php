...
/**
 * Zitadelappv1OIDCConfig Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Zitadelappv1OIDCConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'zitadelappv1OIDCConfig';
    ...
    protected static $openAPITypes = [
        ...
        'version' => '\ArthurHlt\Zitadel\Model\V1OIDCVersion',
        'noneCompliant' => 'bool',
        'complianceProblems' => '\ArthurHlt\Zitadel\Model\V1LocalizedMessage[]',
        'devMode' => 'bool',
    ...
    */
     ...
     * Sets clientId
     *
     * @param string|null $clientId generated oauth2/oidc client id
     *
     * @return self
     */
     ...
     * Gets version
     *
     * @return \ArthurHlt\Zitadel\Model\V1OIDCVersion|null
     */
     ...
     * Sets version
     *
     * @param \ArthurHlt\Zitadel\Model\V1OIDCVersion|null $version version
     *
     * @return self
     */
     ...
     * Sets noneCompliant
     *
     * @param bool|null $noneCompliant specifies whether the config is OIDC compliant. A production configuration SHOULD be compliant
     *
     * @return self
     */
     ...
     *
     * @param \ArthurHlt\Zitadel\Model\V1LocalizedMessage[]|null $complianceProblems lists the problems for non-compliancy
     *
     * @return self
     */
     ...
     * Sets devMode
     *
     * @param bool|null $devMode used for development
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $additionalOrigins additional origins (other than the redirect_uris) from where the API can be used
     *
     * @return self
     */
     ...
     * Sets allowedOrigins
     *
     * @param string[]|null $allowedOrigins all allowed origins from where the API can be used
     *
     * @return self
     */
