...
/**
 * Sessionv2SessionServiceSetSessionBody Class Doc Comment
 *
 * @category Class
 * @package  ArthurHlt\Zitadel
 * @author   OpenAPI Generator team
 ...
 */
class Sessionv2SessionServiceSetSessionBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'sessionv2SessionServiceSetSessionBody';
    ...
    protected static $openAPITypes = [
        'sessionToken' => 'string',
        'checks' => '\ArthurHlt\Zitadel\Model\Sessionv2Checks',
        'metadata' => 'array<string,string>',
        'challenges' => '\ArthurHlt\Zitadel\Model\Sessionv2RequestChallenges',
        'lifetime' => 'string'
    ];
    ...
    */
    ...
    public function setSessionToken($sessionToken)
    {
        ...
        if ((mb_strlen($sessionToken) > 200)) {
            throw new \InvalidArgumentException('invalid length for $sessionToken when calling Sessionv2SessionServiceSetSessionBody., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($sessionToken) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sessionToken when calling Sessionv2SessionServiceSetSessionBody., must be bigger than or equal to 1.');
        }
     ...
     * Gets checks
     *
     * @return \ArthurHlt\Zitadel\Model\Sessionv2Checks|null
     */
     ...
     * Sets checks
     *
     * @param \ArthurHlt\Zitadel\Model\Sessionv2Checks|null $checks checks
     *
     * @return self
     */
     ...
     * Gets challenges
     *
     * @return \ArthurHlt\Zitadel\Model\Sessionv2RequestChallenges|null
     */
     ...
     * Sets challenges
     *
     * @param \ArthurHlt\Zitadel\Model\Sessionv2RequestChallenges|null $challenges challenges
     *
     * @return self
     */
