# ArthurHlt\Zitadel\MessageTextsApi
...
[**adminServiceGetDefaultVerifySMSOTPMessageText()**](MessageTextsApi.md#adminServiceGetDefaultVerifySMSOTPMessageText) | **GET** /text/default/message/verifysmsotp/{language_1} | Get Default Verify SMS OTP Message Text
...
[**managementServiceGetCustomDomainClaimedMessageText()**](MessageTextsApi.md#managementServiceGetCustomDomainClaimedMessageText) | **GET** /text/message/domainclaimed/{language} | Get Custom Domain Claimed Message Text
...
[**managementServiceResetCustomInviteUserMessageTextToDefault()**](MessageTextsApi.md#managementServiceResetCustomInviteUserMessageTextToDefault) | **DELETE** /text/message/invite_user/{language} | Reset Custom Invite User Message Text to Default
...
[**\ArthurHlt\Zitadel\Model\Zitadeladminv1GetCustomDomainClaimedMessageTextResponse**](../Model/Zitadeladminv1GetCustomDomainClaimedMessageTextResponse.md)
...
## `adminServiceGetCustomVerifyPhoneMessageText()`
...
[**\ArthurHlt\Zitadel\Model\Zitadeladminv1GetCustomVerifyPhoneMessageTextResponse**](../Model/Zitadeladminv1GetCustomVerifyPhoneMessageTextResponse.md)
...
## `adminServiceGetDefaultVerifyEmailMessageText()`
...
## `adminServiceResetCustomPasswordResetMessageTextToDefault()`
...
[**\ArthurHlt\Zitadel\Model\Zitadeladminv1ResetCustomPasswordResetMessageTextToDefaultResponse**](../Model/Zitadeladminv1ResetCustomPasswordResetMessageTextToDefaultResponse.md)
...
try {
    $result = $apiInstance->managementServiceGetCustomInitMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetCustomInitMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomInitMessageTextResponse**](../Model/Zitadelmanagementv1GetCustomInitMessageTextResponse.md)
...
## `managementServiceGetCustomInviteUserMessageText()`

```php
managementServiceGetCustomInviteUserMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomInviteUserMessageTextResponse
```

Get Custom Invite User Message Text

Get the custom text of the password-changed message/email that is configured on the organization. The message is sent when an invite code email is requested.
...
try {
    $result = $apiInstance->managementServiceGetCustomInviteUserMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetCustomInviteUserMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomInviteUserMessageTextResponse**](../Model/Zitadelmanagementv1GetCustomInviteUserMessageTextResponse.md)
...
## `managementServiceGetCustomPasswordChangeMessageText()`

```php
managementServiceGetCustomPasswordChangeMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomPasswordChangeMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetCustomPasswordChangeMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetCustomPasswordChangeMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomPasswordChangeMessageTextResponse**](../Model/Zitadelmanagementv1GetCustomPasswordChangeMessageTextResponse.md)
...
## `managementServiceGetCustomPasswordResetMessageText()`

```php
managementServiceGetCustomPasswordResetMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomPasswordResetMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetCustomPasswordResetMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetCustomPasswordResetMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomPasswordResetMessageTextResponse**](../Model/Zitadelmanagementv1GetCustomPasswordResetMessageTextResponse.md)
...
## `managementServiceGetCustomPasswordlessRegistrationMessageText()`

```php
managementServiceGetCustomPasswordlessRegistrationMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomPasswordlessRegistrationMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetCustomPasswordlessRegistrationMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetCustomPasswordlessRegistrationMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomPasswordlessRegistrationMessageTextResponse**](../Model/Zitadelmanagementv1GetCustomPasswordlessRegistrationMessageTextResponse.md)
...
## `managementServiceGetCustomVerifyEmailMessageText()`

```php
managementServiceGetCustomVerifyEmailMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomVerifyEmailMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetCustomVerifyEmailMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetCustomVerifyEmailMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomVerifyEmailMessageTextResponse**](../Model/Zitadelmanagementv1GetCustomVerifyEmailMessageTextResponse.md)
...
## `managementServiceGetCustomVerifyEmailOTPMessageText()`

```php
managementServiceGetCustomVerifyEmailOTPMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomVerifyEmailOTPMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetCustomVerifyEmailOTPMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetCustomVerifyEmailOTPMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomVerifyEmailOTPMessageTextResponse**](../Model/Zitadelmanagementv1GetCustomVerifyEmailOTPMessageTextResponse.md)
...
## `managementServiceGetCustomVerifyPhoneMessageText()`

```php
managementServiceGetCustomVerifyPhoneMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomVerifyPhoneMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetCustomVerifyPhoneMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetCustomVerifyPhoneMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomVerifyPhoneMessageTextResponse**](../Model/Zitadelmanagementv1GetCustomVerifyPhoneMessageTextResponse.md)
...
## `managementServiceGetCustomVerifySMSOTPMessageText()`

```php
managementServiceGetCustomVerifySMSOTPMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomVerifySMSOTPMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetCustomVerifySMSOTPMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetCustomVerifySMSOTPMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetCustomVerifySMSOTPMessageTextResponse**](../Model/Zitadelmanagementv1GetCustomVerifySMSOTPMessageTextResponse.md)
...
## `managementServiceGetDefaultDomainClaimedMessageText()`

```php
managementServiceGetDefaultDomainClaimedMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultDomainClaimedMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetDefaultDomainClaimedMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetDefaultDomainClaimedMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultDomainClaimedMessageTextResponse**](../Model/Zitadelmanagementv1GetDefaultDomainClaimedMessageTextResponse.md)
...
## `managementServiceGetDefaultInitMessageText()`

```php
managementServiceGetDefaultInitMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultInitMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetDefaultInitMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetDefaultInitMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultInitMessageTextResponse**](../Model/Zitadelmanagementv1GetDefaultInitMessageTextResponse.md)
...
## `managementServiceGetDefaultInviteUserMessageText()`

```php
managementServiceGetDefaultInviteUserMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultInviteUserMessageTextResponse
```

Get Default Invite User Message Text

Get the default text of the invite user message/email that is configured on the instance or as translation files in ZITADEL itself. The message is sent when an invite code email is requested.
...
try {
    $result = $apiInstance->managementServiceGetDefaultInviteUserMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetDefaultInviteUserMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultInviteUserMessageTextResponse**](../Model/Zitadelmanagementv1GetDefaultInviteUserMessageTextResponse.md)
...
## `managementServiceGetDefaultPasswordChangeMessageText()`

```php
managementServiceGetDefaultPasswordChangeMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultPasswordChangeMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetDefaultPasswordChangeMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetDefaultPasswordChangeMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultPasswordChangeMessageTextResponse**](../Model/Zitadelmanagementv1GetDefaultPasswordChangeMessageTextResponse.md)
...
## `managementServiceGetDefaultPasswordResetMessageText()`

```php
managementServiceGetDefaultPasswordResetMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultPasswordResetMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetDefaultPasswordResetMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetDefaultPasswordResetMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultPasswordResetMessageTextResponse**](../Model/Zitadelmanagementv1GetDefaultPasswordResetMessageTextResponse.md)
...
## `managementServiceGetDefaultPasswordlessRegistrationMessageText()`

```php
managementServiceGetDefaultPasswordlessRegistrationMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultPasswordlessRegistrationMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetDefaultPasswordlessRegistrationMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetDefaultPasswordlessRegistrationMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultPasswordlessRegistrationMessageTextResponse**](../Model/Zitadelmanagementv1GetDefaultPasswordlessRegistrationMessageTextResponse.md)
...
## `managementServiceGetDefaultVerifyEmailMessageText()`

```php
managementServiceGetDefaultVerifyEmailMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultVerifyEmailMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetDefaultVerifyEmailMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetDefaultVerifyEmailMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultVerifyEmailMessageTextResponse**](../Model/Zitadelmanagementv1GetDefaultVerifyEmailMessageTextResponse.md)
...
## `managementServiceGetDefaultVerifyEmailOTPMessageText()`

```php
managementServiceGetDefaultVerifyEmailOTPMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultVerifyEmailOTPMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetDefaultVerifyEmailOTPMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetDefaultVerifyEmailOTPMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultVerifyEmailOTPMessageTextResponse**](../Model/Zitadelmanagementv1GetDefaultVerifyEmailOTPMessageTextResponse.md)
...
## `managementServiceGetDefaultVerifyPhoneMessageText()`

```php
managementServiceGetDefaultVerifyPhoneMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultVerifyPhoneMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetDefaultVerifyPhoneMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetDefaultVerifyPhoneMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultVerifyPhoneMessageTextResponse**](../Model/Zitadelmanagementv1GetDefaultVerifyPhoneMessageTextResponse.md)
...
## `managementServiceGetDefaultVerifySMSOTPMessageText()`

```php
managementServiceGetDefaultVerifySMSOTPMessageText($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultVerifySMSOTPMessageTextResponse
```
...
try {
    $result = $apiInstance->managementServiceGetDefaultVerifySMSOTPMessageText($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceGetDefaultVerifySMSOTPMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1GetDefaultVerifySMSOTPMessageTextResponse**](../Model/Zitadelmanagementv1GetDefaultVerifySMSOTPMessageTextResponse.md)
...
## `managementServiceResetCustomDomainClaimedMessageTextToDefault()`

```php
managementServiceResetCustomDomainClaimedMessageTextToDefault($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomDomainClaimedMessageTextToDefaultResponse
```
...
try {
    $result = $apiInstance->managementServiceResetCustomDomainClaimedMessageTextToDefault($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceResetCustomDomainClaimedMessageTextToDefault: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomDomainClaimedMessageTextToDefaultResponse**](../Model/Zitadelmanagementv1ResetCustomDomainClaimedMessageTextToDefaultResponse.md)
...
## `managementServiceResetCustomInitMessageTextToDefault()`

```php
managementServiceResetCustomInitMessageTextToDefault($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomInitMessageTextToDefaultResponse
```
...
try {
    $result = $apiInstance->managementServiceResetCustomInitMessageTextToDefault($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceResetCustomInitMessageTextToDefault: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomInitMessageTextToDefaultResponse**](../Model/Zitadelmanagementv1ResetCustomInitMessageTextToDefaultResponse.md)
...
## `managementServiceResetCustomInviteUserMessageTextToDefault()`

```php
managementServiceResetCustomInviteUserMessageTextToDefault($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomInviteUserMessageTextToDefaultResponse
```

Reset Custom Invite User Message Text to Default

Removes the custom text of the invite user message from the organization and therefore the default texts from the instance or translation files will be triggered for the users.
...
try {
    $result = $apiInstance->managementServiceResetCustomInviteUserMessageTextToDefault($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceResetCustomInviteUserMessageTextToDefault: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomInviteUserMessageTextToDefaultResponse**](../Model/Zitadelmanagementv1ResetCustomInviteUserMessageTextToDefaultResponse.md)
...
## `managementServiceResetCustomPasswordChangeMessageTextToDefault()`

```php
managementServiceResetCustomPasswordChangeMessageTextToDefault($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomPasswordChangeMessageTextToDefaultResponse
```
...
try {
    $result = $apiInstance->managementServiceResetCustomPasswordChangeMessageTextToDefault($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceResetCustomPasswordChangeMessageTextToDefault: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomPasswordChangeMessageTextToDefaultResponse**](../Model/Zitadelmanagementv1ResetCustomPasswordChangeMessageTextToDefaultResponse.md)
...
## `managementServiceResetCustomPasswordResetMessageTextToDefault()`

```php
managementServiceResetCustomPasswordResetMessageTextToDefault($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomPasswordResetMessageTextToDefaultResponse
```
...
try {
    $result = $apiInstance->managementServiceResetCustomPasswordResetMessageTextToDefault($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceResetCustomPasswordResetMessageTextToDefault: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomPasswordResetMessageTextToDefaultResponse**](../Model/Zitadelmanagementv1ResetCustomPasswordResetMessageTextToDefaultResponse.md)
...
## `managementServiceResetCustomPasswordlessRegistrationMessageTextToDefault()`

```php
managementServiceResetCustomPasswordlessRegistrationMessageTextToDefault($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomPasswordlessRegistrationMessageTextToDefaultResponse
```
...
try {
    $result = $apiInstance->managementServiceResetCustomPasswordlessRegistrationMessageTextToDefault($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceResetCustomPasswordlessRegistrationMessageTextToDefault: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomPasswordlessRegistrationMessageTextToDefaultResponse**](../Model/Zitadelmanagementv1ResetCustomPasswordlessRegistrationMessageTextToDefaultResponse.md)
...
## `managementServiceResetCustomVerifyEmailMessageTextToDefault()`

```php
managementServiceResetCustomVerifyEmailMessageTextToDefault($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomVerifyEmailMessageTextToDefaultResponse
```
...
try {
    $result = $apiInstance->managementServiceResetCustomVerifyEmailMessageTextToDefault($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceResetCustomVerifyEmailMessageTextToDefault: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomVerifyEmailMessageTextToDefaultResponse**](../Model/Zitadelmanagementv1ResetCustomVerifyEmailMessageTextToDefaultResponse.md)
...
## `managementServiceResetCustomVerifyEmailOTPMessageTextToDefault()`

```php
managementServiceResetCustomVerifyEmailOTPMessageTextToDefault($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomVerifyEmailOTPMessageTextToDefaultResponse
```
...
try {
    $result = $apiInstance->managementServiceResetCustomVerifyEmailOTPMessageTextToDefault($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceResetCustomVerifyEmailOTPMessageTextToDefault: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomVerifyEmailOTPMessageTextToDefaultResponse**](../Model/Zitadelmanagementv1ResetCustomVerifyEmailOTPMessageTextToDefaultResponse.md)
...
## `managementServiceResetCustomVerifyPhoneMessageTextToDefault()`

```php
managementServiceResetCustomVerifyPhoneMessageTextToDefault($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomVerifyPhoneMessageTextToDefaultResponse
```
...
try {
    $result = $apiInstance->managementServiceResetCustomVerifyPhoneMessageTextToDefault($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceResetCustomVerifyPhoneMessageTextToDefault: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomVerifyPhoneMessageTextToDefaultResponse**](../Model/Zitadelmanagementv1ResetCustomVerifyPhoneMessageTextToDefaultResponse.md)
...
## `managementServiceResetCustomVerifySMSOTPMessageTextToDefault()`

```php
managementServiceResetCustomVerifySMSOTPMessageTextToDefault($language, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomVerifySMSOTPMessageTextToDefaultResponse
```
...
try {
    $result = $apiInstance->managementServiceResetCustomVerifySMSOTPMessageTextToDefault($language, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceResetCustomVerifySMSOTPMessageTextToDefault: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\ArthurHlt\Zitadel\Model\Zitadelmanagementv1ResetCustomVerifySMSOTPMessageTextToDefaultResponse**](../Model/Zitadelmanagementv1ResetCustomVerifySMSOTPMessageTextToDefaultResponse.md)
...
## `managementServiceSetCustomDomainClaimedMessageCustomText()`

```php
managementServiceSetCustomDomainClaimedMessageCustomText($language, $body, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\V1SetCustomDomainClaimedMessageTextResponse
```
...
$language = 'language_example'; // string
$body = new \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomDomainClaimedMessageCustomTextBody(); // \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomDomainClaimedMessageCustomTextBody
$xZitadelOrgid = 'xZitadelOrgid_example'; // string | The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data.

try {
    $result = $apiInstance->managementServiceSetCustomDomainClaimedMessageCustomText($language, $body, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceSetCustomDomainClaimedMessageCustomText: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **language** | **string**|  |
 **body** | [**\ArthurHlt\Zitadel\Model\ManagementServiceSetCustomDomainClaimedMessageCustomTextBody**](../Model/ManagementServiceSetCustomDomainClaimedMessageCustomTextBody.md)|  |
 **xZitadelOrgid** | **string**| The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data. | [optional]

### Return type

[**\ArthurHlt\Zitadel\Model\V1SetCustomDomainClaimedMessageTextResponse**](../Model/V1SetCustomDomainClaimedMessageTextResponse.md)
...
## `managementServiceSetCustomInitMessageText()`

```php
managementServiceSetCustomInitMessageText($language, $body, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\V1SetCustomInitMessageTextResponse
```
...
$language = 'language_example'; // string
$body = new \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomInitMessageTextBody(); // \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomInitMessageTextBody
$xZitadelOrgid = 'xZitadelOrgid_example'; // string | The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data.

try {
    $result = $apiInstance->managementServiceSetCustomInitMessageText($language, $body, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceSetCustomInitMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **language** | **string**|  |
 **body** | [**\ArthurHlt\Zitadel\Model\ManagementServiceSetCustomInitMessageTextBody**](../Model/ManagementServiceSetCustomInitMessageTextBody.md)|  |
 **xZitadelOrgid** | **string**| The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data. | [optional]

### Return type

[**\ArthurHlt\Zitadel\Model\V1SetCustomInitMessageTextResponse**](../Model/V1SetCustomInitMessageTextResponse.md)
...
## `managementServiceSetCustomInviteUserMessageCustomText()`

```php
managementServiceSetCustomInviteUserMessageCustomText($language, $body, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\V1SetCustomInviteUserMessageTextResponse
```
...
$language = 'language_example'; // string
$body = new \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomInviteUserMessageCustomTextBody(); // \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomInviteUserMessageCustomTextBody
$xZitadelOrgid = 'xZitadelOrgid_example'; // string | The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data.

try {
    $result = $apiInstance->managementServiceSetCustomInviteUserMessageCustomText($language, $body, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceSetCustomInviteUserMessageCustomText: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **language** | **string**|  |
 **body** | [**\ArthurHlt\Zitadel\Model\ManagementServiceSetCustomInviteUserMessageCustomTextBody**](../Model/ManagementServiceSetCustomInviteUserMessageCustomTextBody.md)|  |
 **xZitadelOrgid** | **string**| The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data. | [optional]

### Return type

[**\ArthurHlt\Zitadel\Model\V1SetCustomInviteUserMessageTextResponse**](../Model/V1SetCustomInviteUserMessageTextResponse.md)
...
## `managementServiceSetCustomPasswordChangeMessageCustomText()`

```php
managementServiceSetCustomPasswordChangeMessageCustomText($language, $body, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\V1SetCustomPasswordChangeMessageTextResponse
```
...
$language = 'language_example'; // string
$body = new \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomPasswordChangeMessageCustomTextBody(); // \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomPasswordChangeMessageCustomTextBody
$xZitadelOrgid = 'xZitadelOrgid_example'; // string | The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data.

try {
    $result = $apiInstance->managementServiceSetCustomPasswordChangeMessageCustomText($language, $body, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceSetCustomPasswordChangeMessageCustomText: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **language** | **string**|  |
 **body** | [**\ArthurHlt\Zitadel\Model\ManagementServiceSetCustomPasswordChangeMessageCustomTextBody**](../Model/ManagementServiceSetCustomPasswordChangeMessageCustomTextBody.md)|  |
 **xZitadelOrgid** | **string**| The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data. | [optional]

### Return type

[**\ArthurHlt\Zitadel\Model\V1SetCustomPasswordChangeMessageTextResponse**](../Model/V1SetCustomPasswordChangeMessageTextResponse.md)
...
## `managementServiceSetCustomPasswordResetMessageText()`

```php
managementServiceSetCustomPasswordResetMessageText($language, $body, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\V1SetCustomPasswordResetMessageTextResponse
```
...
$language = 'language_example'; // string
$body = new \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomPasswordResetMessageTextBody(); // \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomPasswordResetMessageTextBody
$xZitadelOrgid = 'xZitadelOrgid_example'; // string | The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data.

try {
    $result = $apiInstance->managementServiceSetCustomPasswordResetMessageText($language, $body, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceSetCustomPasswordResetMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **language** | **string**|  |
 **body** | [**\ArthurHlt\Zitadel\Model\ManagementServiceSetCustomPasswordResetMessageTextBody**](../Model/ManagementServiceSetCustomPasswordResetMessageTextBody.md)|  |
 **xZitadelOrgid** | **string**| The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data. | [optional]

### Return type

[**\ArthurHlt\Zitadel\Model\V1SetCustomPasswordResetMessageTextResponse**](../Model/V1SetCustomPasswordResetMessageTextResponse.md)
...
## `managementServiceSetCustomPasswordlessRegistrationMessageCustomText()`

```php
managementServiceSetCustomPasswordlessRegistrationMessageCustomText($language, $body, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\V1SetCustomPasswordlessRegistrationMessageTextResponse
```
...
$language = 'language_example'; // string
$body = new \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomPasswordlessRegistrationMessageCustomTextBody(); // \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomPasswordlessRegistrationMessageCustomTextBody
$xZitadelOrgid = 'xZitadelOrgid_example'; // string | The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data.

try {
    $result = $apiInstance->managementServiceSetCustomPasswordlessRegistrationMessageCustomText($language, $body, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceSetCustomPasswordlessRegistrationMessageCustomText: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **language** | **string**|  |
 **body** | [**\ArthurHlt\Zitadel\Model\ManagementServiceSetCustomPasswordlessRegistrationMessageCustomTextBody**](../Model/ManagementServiceSetCustomPasswordlessRegistrationMessageCustomTextBody.md)|  |
 **xZitadelOrgid** | **string**| The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data. | [optional]

### Return type

[**\ArthurHlt\Zitadel\Model\V1SetCustomPasswordlessRegistrationMessageTextResponse**](../Model/V1SetCustomPasswordlessRegistrationMessageTextResponse.md)
...
## `managementServiceSetCustomVerifyEmailMessageText()`

```php
managementServiceSetCustomVerifyEmailMessageText($language, $body, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\V1SetCustomVerifyEmailMessageTextResponse
```
...
$language = 'language_example'; // string
$body = new \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifyEmailMessageTextBody(); // \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifyEmailMessageTextBody
$xZitadelOrgid = 'xZitadelOrgid_example'; // string | The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data.

try {
    $result = $apiInstance->managementServiceSetCustomVerifyEmailMessageText($language, $body, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceSetCustomVerifyEmailMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **language** | **string**|  |
 **body** | [**\ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifyEmailMessageTextBody**](../Model/ManagementServiceSetCustomVerifyEmailMessageTextBody.md)|  |
 **xZitadelOrgid** | **string**| The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data. | [optional]

### Return type

[**\ArthurHlt\Zitadel\Model\V1SetCustomVerifyEmailMessageTextResponse**](../Model/V1SetCustomVerifyEmailMessageTextResponse.md)
...
## `managementServiceSetCustomVerifyEmailOTPMessageText()`

```php
managementServiceSetCustomVerifyEmailOTPMessageText($language, $body, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\V1SetCustomVerifyEmailOTPMessageTextResponse
```
...
$language = 'language_example'; // string
$body = new \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifyEmailOTPMessageTextBody(); // \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifyEmailOTPMessageTextBody
$xZitadelOrgid = 'xZitadelOrgid_example'; // string | The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data.

try {
    $result = $apiInstance->managementServiceSetCustomVerifyEmailOTPMessageText($language, $body, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceSetCustomVerifyEmailOTPMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **language** | **string**|  |
 **body** | [**\ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifyEmailOTPMessageTextBody**](../Model/ManagementServiceSetCustomVerifyEmailOTPMessageTextBody.md)|  |
 **xZitadelOrgid** | **string**| The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data. | [optional]

### Return type

[**\ArthurHlt\Zitadel\Model\V1SetCustomVerifyEmailOTPMessageTextResponse**](../Model/V1SetCustomVerifyEmailOTPMessageTextResponse.md)
...
## `managementServiceSetCustomVerifyPhoneMessageText()`

```php
managementServiceSetCustomVerifyPhoneMessageText($language, $body, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\V1SetCustomVerifyPhoneMessageTextResponse
```
...
$language = 'language_example'; // string
$body = new \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifyPhoneMessageTextBody(); // \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifyPhoneMessageTextBody
$xZitadelOrgid = 'xZitadelOrgid_example'; // string | The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data.

try {
    $result = $apiInstance->managementServiceSetCustomVerifyPhoneMessageText($language, $body, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceSetCustomVerifyPhoneMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **language** | **string**|  |
 **body** | [**\ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifyPhoneMessageTextBody**](../Model/ManagementServiceSetCustomVerifyPhoneMessageTextBody.md)|  |
 **xZitadelOrgid** | **string**| The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data. | [optional]

### Return type

[**\ArthurHlt\Zitadel\Model\V1SetCustomVerifyPhoneMessageTextResponse**](../Model/V1SetCustomVerifyPhoneMessageTextResponse.md)
...
## `managementServiceSetCustomVerifySMSOTPMessageText()`

```php
managementServiceSetCustomVerifySMSOTPMessageText($language, $body, $xZitadelOrgid): \ArthurHlt\Zitadel\Model\V1SetCustomVerifySMSOTPMessageTextResponse
```
...
$language = 'language_example'; // string
$body = new \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifySMSOTPMessageTextBody(); // \ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifySMSOTPMessageTextBody
$xZitadelOrgid = 'xZitadelOrgid_example'; // string | The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data.

try {
    $result = $apiInstance->managementServiceSetCustomVerifySMSOTPMessageText($language, $body, $xZitadelOrgid);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling MessageTextsApi->managementServiceSetCustomVerifySMSOTPMessageText: ', $e->getMessage(), PHP_EOL;
}
```
...
------------- | ------------- | ------------- | -------------
 **language** | **string**|  |
 **body** | [**\ArthurHlt\Zitadel\Model\ManagementServiceSetCustomVerifySMSOTPMessageTextBody**](../Model/ManagementServiceSetCustomVerifySMSOTPMessageTextBody.md)|  |
 **xZitadelOrgid** | **string**| The default is always the organization of the requesting user. If you like to get/set a result of another organization include the header. Make sure the user has permission to access the requested data. | [optional]

### Return type

[**\ArthurHlt\Zitadel\Model\V1SetCustomVerifySMSOTPMessageTextResponse**](../Model/V1SetCustomVerifySMSOTPMessageTextResponse.md)
